...
public class CreateYnabAccountMappingRequestValidator : AbstractValidator<CreateYnabAccountMappingRequest>
{
	public const string ReceiptsAccountIdMustNotBeEmpty = "Receipts account ID must not be empty.";
	...
	public CreateYnabAccountMappingRequestValidator()
	{
		RuleFor(x => x.ReceiptsAccountId)
			.NotEmpty()
			.WithMessage(ReceiptsAccountIdMustNotBeEmpty);
