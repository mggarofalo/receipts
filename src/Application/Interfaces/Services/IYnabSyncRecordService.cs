...
public interface IYnabSyncRecordService
{
	...
	Task<IReadOnlyList<YnabPushOperationIdentity>> GetPushOperationIdentitiesByReceiptAsync(Guid receiptId, string ynabBudgetId, CancellationToken cancellationToken);
