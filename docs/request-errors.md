...
The remaining RECEIPTS-948 backup transfer work will adopt this policy while moving import/export onto the shared refresh/replay transport. Its raw-fetch expired-JWT gaps and five-minute import timeout are still to fix. Error routes and render boundaries remain available throughout this adoption.
